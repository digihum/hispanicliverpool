...
(function() {
  require(["jquery", "underscore", "backbone", "bootstrap", "backbonePaginator"], function($, _, Backbone, Bootstrap, PageableCollection) {
    var Countries, Country, PaginatedPeople, People, PeopleListView, PeopleSearch, PeopleSearchResultsView, Person, PersonSingleView, Relationship, Relationships, Router, SearchFormView, htmlEncode, people, router;
    ...
    PeopleSearchResultsView = Backbone.View.extend({
      ...
      render: function(querystring) {
        var peopleResults, that;
        that = this;
        peopleResults = new PeopleSearch;
        return peopleResults.fetch({
          ...
          success: function(people) {
            ...
            return require(["backgrid"], function(Backgrid) {
              ...
              return that.$el.append(peopleGrid.render().el);
            });
          }
        });
      }
